...
"""
.. module: security_monkey.tests.watchers.vpc.test_vpn
    :platform: Unix
...
class VPNWatcherTestCase(SecurityMonkeyWatcherTestCase):

    @freeze_time("2017-04-16 12:00:00")
    @mock_sts
    @mock_ec2
    def test_slurp(self):
        ...
        watcher = VPN(accounts=[self.account.name])
